#####################################################################
# Game Server
# Developed by Leighlyn Ha, Eyas Rashid, and Alex van Zuiden-Rylander
# Fall Quarter 2019
#####################################################################
...
try:
    # setup server socket
    hostIP = input('Please type the public IP address to setup the server: ')
    host = hostIP 
    port = 15000
    ...
    print('Could not set up server socket. Either IP address is incorrect or another application is using port 15000.')
